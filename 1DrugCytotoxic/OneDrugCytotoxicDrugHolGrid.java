...
public class OneDrugCytotoxicDrugHolGrid extends AgentGrid2D<OneDrugCytotoxicDrugHolCell> {
    //model constants
...
//        drugB = new PDEGrid2D(xDim, yDim);
    ...
    public static void main(String[] args) {
        ...
        OneDrugCytotoxicDrugHolGrid[] models = new OneDrugCytotoxicDrugHolGrid[4];
...
//        double AT_alpha_drug_B=0.5;
        double AT_beta=0.1;
        double Max_Tolerated_Dose_A=3.75;
...
//
//        ShuffleAgents(rn);
//        for (OneDrugCytotoxicDrugHolCell cell : this) {
//            cell.CellStep();
//        }
//
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            OneDrugCytotoxicDrugHolCell drawMe = GetAgent(i);
...
class OneDrugCytotoxicDrugHolCell extends AgentSQ2Dunstackable<OneDrugCytotoxicDrugHolGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        OneDrugCytotoxicDrugHolCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                OneDrugCytotoxicDrugHolCell tmpAgent = G.GetAgent(tmpAgentIndex);
