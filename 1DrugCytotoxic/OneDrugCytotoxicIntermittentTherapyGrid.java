...
public class OneDrugCytotoxicIntermittentTherapyGrid extends AgentGrid2D<OneDrugCytotoxicIntermittentTherapyCell> {
    //model constants
...
//        drugB = new PDEGrid2D(xDim, yDim);
    ...
    public static void main(String[] args) {
        ...
        OneDrugCytotoxicIntermittentTherapyGrid[] models = new OneDrugCytotoxicIntermittentTherapyGrid[4];
        String strategy = "Int";
        String sub_strategy = "1DrugCytotoxicLoDrug";
...
//
//        ShuffleAgents(rn);
//        for (OneDrugCytotoxicIntermittentTherapyCell cell : this) {
//            cell.CellStep();
//        }
//
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            OneDrugCytotoxicIntermittentTherapyCell drawMe = GetAgent(i);
...
class OneDrugCytotoxicIntermittentTherapyCell extends AgentSQ2Dunstackable<OneDrugCytotoxicIntermittentTherapyGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        OneDrugCytotoxicIntermittentTherapyCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                OneDrugCytotoxicIntermittentTherapyCell tmpAgent = G.GetAgent(tmpAgentIndex);
