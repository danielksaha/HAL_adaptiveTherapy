...
public class OneDrugCytostaticDrugHolGrid extends AgentGrid2D<OneDrugCytostaticDrugHolCell> {
    //model constants
...
//        drugB = new PDEGrid2D(xDim, yDim);
    ...
    public static void main(String[] args) {
        ...
        OneDrugCytostaticDrugHolGrid[] models = new OneDrugCytostaticDrugHolGrid[4];
...
//        double AT_alpha_drug_B=0.5;
        double AT_beta=0.1;
        double Max_Tolerated_Dose_A=0.15;
...
//
//        ShuffleAgents(rn);
//        for (OneDrugCytostaticDrugHolCell cell : this) {
//            cell.CellStep();
//        }
//
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            OneDrugCytostaticDrugHolCell drawMe = GetAgent(i);
...
class OneDrugCytostaticDrugHolCell extends AgentSQ2Dunstackable<OneDrugCytostaticDrugHolGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        OneDrugCytostaticDrugHolCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                OneDrugCytostaticDrugHolCell tmpAgent = G.GetAgent(tmpAgentIndex);
