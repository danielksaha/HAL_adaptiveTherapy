...
public class CkTandemMultGrid extends AgentGrid2D<CkTandemMultCell> {
    //model constants
...
//    public double DRUG_ON_TIME = 40, DRUG_OFF_TIME = 160, DRUG_CYCLE_TIME = 200, DRUG_DIFF_RATE = 2.0, DRUG_UPTAKE = 0.91, DRUG_BOUNDARY_VAL = 1.0, DRUG_METABOLISM_TIME = 40.0, DRUG_A_DEATH=0.2, DRUG_B_DEATH=0.2;
    ...
    public static void main(String[] args) {
        ...
        CkTandemMultGrid[] models = new CkTandemMultGrid[4];
...
//
//        ShuffleAgents(rn);
//        for (CkTandemMultCell cell : this) {
//            cell.CellStep();
//        }
//
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            CkTandemMultCell drawMe = GetAgent(i);
...
class CkTandemMultCell extends AgentSQ2Dunstackable<CkTandemMultGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        CkTandemMultCell tmp = G.NewAgentSQ(index);
...
//        Mutate();
        ...
        if (G.rn.Double() < tmp_div_prob) {
            ...
            if (options_empty==0 && G.rn.Double()<G.REPLACEMENT_THRESHOLD) { //&& this.type==G.DOUBLY_RESISTANT) {
                ...
                CkTandemMultCell tmpAgent = G.GetAgent(tmpAgentIndex);
