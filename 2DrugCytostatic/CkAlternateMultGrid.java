...
public class CkAlternateMultGrid extends AgentGrid2D<CkAlternateMultCell> {
    //model constants
...
//    public double DRUG_ON_TIME = 40, DRUG_OFF_TIME = 160, DRUG_CYCLE_TIME = 200, DRUG_DIFF_RATE = 2.0, DRUG_UPTAKE = 0.91, DRUG_BOUNDARY_VAL = 1.0, DRUG_METABOLISM_TIME = 40.0, DRUG_A_DEATH=0.2, DRUG_B_DEATH=0.2;
    ...
    public static void main(String[] args) {
        ...
        CkAlternateMultGrid[] models = new CkAlternateMultGrid[4];
...
//        BufferedReader userInput=new BufferedReader(new InputStreamReader(System.in));
        ...
        double AT_alpha_drug_A=0;
        double AT_alpha_drug_B=0;
...
//
//        ShuffleAgents(rn);
//        for (CkAlternateMultCell cell : this) {
//            cell.CellStep();
//        }
//
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            CkAlternateMultCell drawMe = GetAgent(i);
...
class CkAlternateMultCell extends AgentSQ2Dunstackable<CkAlternateMultGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        CkAlternateMultCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                CkAlternateMultCell tmpAgent = G.GetAgent(tmpAgentIndex);
