...
public class CkTandemAddGridMultiWell extends AgentGrid2D<CkTandemAddCellMultiWell> {
    //model constants
...
//    public double DRUG_ON_TIME = 40, DRUG_OFF_TIME = 160, DRUG_CYCLE_TIME = 200, DRUG_DIFF_RATE = 2.0, DRUG_UPTAKE = 0.91, DRUG_BOUNDARY_VAL = 1.0, DRUG_METABOLISM_TIME = 40.0, DRUG_A_DEATH=0.2, DRUG_B_DEATH=0.2;
    ...
    public static void main(String[] args) {
        ...
        CkTandemAddGridMultiWell[] models = new CkTandemAddGridMultiWell[4];
...
//
//        ShuffleAgents(rn);
//        for (CkTandemAddCellMultiWell cell : this) {
//            cell.CellStep();
//        }
//
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            CkTandemAddCellMultiWell drawMe = GetAgent(i);
...
class CkTandemAddCellMultiWell extends AgentSQ2Dunstackable<CkTandemAddGridMultiWell> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        CkTandemAddCellMultiWell tmp = G.NewAgentSQ(index);
...
//        Mutate();
        ...
        if (G.rn.Double() < tmp_div_prob) {
            ...
            if (options_empty==0 && G.rn.Double()<G.REPLACEMENT_THRESHOLD) { //&& this.type==G.DOUBLY_RESISTANT) {
                ...
                CkTandemAddCellMultiWell tmpAgent = G.GetAgent(tmpAgentIndex);
