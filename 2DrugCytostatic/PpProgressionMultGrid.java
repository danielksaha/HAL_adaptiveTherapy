...
public class PpProgressionMultGrid extends AgentGrid2D<PpProgressionMultCell> {
    //model constants
...
//    public double PERCENT_INCREMENT_DRUG_LAST_CYCLE=0.5;
    ...
    public static void main(String[] args) {
        ...
        PpProgressionMultGrid[] models = new PpProgressionMultGrid[4];
...
//            int tmp = rn.Double() < resistantProb?rn.Double()<resistantProb?DOUBLY_RESISTANT:RESISTANT_TO_DRUG_A:rn.Double()<resistantProb?DOUBLY_SENSITIVE:RESISTANT_TO_DRUG_B;
    ...
    public void ModelStep(int tick) {
        ...
        ShuffleAgents(rn);
        for (PpProgressionMultCell cell : this) {
            cell.CellStep();
        }
    }
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            PpProgressionMultCell drawMe = GetAgent(i);
...
class PpProgressionMultCell extends AgentSQ2Dunstackable<PpProgressionMultGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        PpProgressionMultCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                PpProgressionMultCell tmpAgent = G.GetAgent(tmpAgentIndex);
