...
public class CkAlternateAddGrid extends AgentGrid2D<CkAlternateAddCell> {
    //model constants
...
//    public double DRUG_ON_TIME = 40, DRUG_OFF_TIME = 160, DRUG_CYCLE_TIME = 200, DRUG_DIFF_RATE = 2.0, DRUG_UPTAKE = 0.91, DRUG_BOUNDARY_VAL = 1.0, DRUG_METABOLISM_TIME = 40.0, DRUG_A_DEATH=0.2, DRUG_B_DEATH=0.2;
    ...
    public boolean IS_LAST_DRUG_ADJUSTED_A, IS_LAST_DRUG_ADJUSTED_B;
    ...
    public static void main(String[] args) {
        ...
        CkAlternateAddGrid[] models = new CkAlternateAddGrid[4];
        String strategy = "DosAdjAdd25";
        String sub_strategy ="CkAlt";
        String file_counter = "1";

//        BufferedReader userInput=new BufferedReader(new InputStreamReader(System.in));
        FileIO popsOut=new FileIO(strategy+"-"+sub_strategy+"-"+file_counter,"w");
//        FileIO popsOut=new FileIO(strategy+"-"+sub_strategy+"-"+args[0],"w");
//        FileIO popsOut=new FileIO("CkAlt2.csv","w");
//        BufferedReader userInput=new BufferedReader(new InputStreamReader(System.in));
        ...
        double AT_alpha_drug_A=0.25;
        double AT_alpha_drug_B=0.25;
        double AT_gamma_drug_A=0;
        double AT_gamma_drug_B=0;
        double AT_beta=0.1;
        double Max_Tolerated_Dose_A=3;
        double Max_Tolerated_Dose_B=3;
...
//
//        ShuffleAgents(rn);
//        for (CkAlternateAddCell cell : this) {
//            cell.CellStep();
//        }
//
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            CkAlternateAddCell drawMe = GetAgent(i);
...
class CkAlternateAddCell extends AgentSQ2Dunstackable<CkAlternateAddGrid> {
...
//    public double drug_sensitivity_score;
    ...
    public void DivideAndMutate(int index) {
        CkAlternateAddCell tmp = G.NewAgentSQ(index);
...
//                System.out.println("tmpAgentIndex is " + tmpAgentIndex);
                CkAlternateAddCell tmpAgent = G.GetAgent(tmpAgentIndex);
