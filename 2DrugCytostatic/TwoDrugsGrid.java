...
//This script simulates adaptive therapy with replacement in a growing 2D tumor
...
public class TwoDrugsGrid extends AgentGrid2D<TwoDrugsCell> {
    //model constants
    ...
    public int PREV_POP,PREV_POP_DRUG_A,PREV_POP_DRUG_B, CURRENT_POP,INITIAL_POP,FINAL_POP;
...
//    public double DRUG_ON_TIME = 40, DRUG_OFF_TIME = 160, DRUG_CYCLE_TIME = 200, DRUG_DIFF_RATE = 2.0, DRUG_UPTAKE = 0.91, DRUG_BOUNDARY_VAL = 1.0, DRUG_METABOLISM_TIME = 40.0, DRUG_A_DEATH=0.2, DRUG_B_DEATH=0.2;
    ...
    public static void main(String[] args) {
        ...
        TwoDrugsGrid[] models = new TwoDrugsGrid[4];
//        String strategy = "DosAdjAdd25";
//        String sub_strategy ="CkTan";

//        String my_strategy="DosAdjCkTanAdd-DelDose-0.25-MTD_RF-1-MTD-3";
        String my_strategy="DosAdjCkTanAdd-DelDose-0.5-MTD_RF-1-MTD-3";
//        String my_strategy="DosAdjCkTanMult-DelDose-1.5-MTD_RF-1-MTD-3";
//        String my_strategy="DosAdjCkTanMult-DelDose-2-MTD_RF-1-MTD-3";

//        String my_strategy="DosAdjCkAltAdd-DelDose-0.25-MTD_RF-1-MTD-3";
//        String my_strategy="DosAdjCkAltAdd-DelDose-0.5-MTD_RF-1-MTD-3";
//        String my_strategy="DosAdjCkAltMult-DelDose-1.5-MTD_RF-1-MTD-3";
//        String my_strategy="DosAdjCkAltMult-DelDose-2-MTD_RF-1-MTD-3";

//        String my_strategy="DosAdjPpEveryDoseAdd-DelDose-0.25-MTD_RF-1-MTD-5";
//        String my_strategy="DosAdjPpEveryDoseAdd-DelDose-0.5-MTD_RF-1-MTD-5";
//        String my_strategy="DosAdjPpEveryDoseMult-DelDose-1.5-MTD_RF-1-MTD-5";
//        String my_strategy="DosAdjPpEveryDoseMult-DelDose-2-MTD_RF-1-MTD-5";

//        String my_strategy="DosAdjPpOnProgAdd-DelDose-0.25-MTD_RF-1-MTD-5";
//        String my_strategy="DosAdjPpOnProgAdd-DelDose-0.5-MTD_RF-1-MTD-5";
//        String my_strategy="DosAdjPpOnProgMult-DelDose-1.5-MTD_RF-1-MTD-5";
//        String my_strategy="DosAdjPpOnProgMult-DelDose-2-MTD_RF-1-MTD-5";

//        String my_strategy="IntFixedDoseCk-DelDose-0-MTD_RF-1-MTD-3";
//        String my_strategy="IntFixedDoseCk-DelDose-0-MTD_RF-0.75-MTD-3";
//        String my_strategy="IntFixedDosePp-DelDose-0-MTD_RF-1.0-MTD-5";
//        String my_strategy="IntFixedDosePp-DelDose-0-MTD_RF-0.75-MTD-5";

//        String my_strategy="HolFixedDoseCk-DelDose-0-MTD_RF-1-MTD-3";
//        String my_strategy="HolFixedDoseCk-DelDose-0-MTD_RF-0.75-MTD-3";
//        String my_strategy="HolFixedDosePp-DelDose-0-MTD_RF-1-MTD-5";
//        String my_strategy="HolFixedDosePp-DelDose-0-MTD_RF-0.75-MTD-5";
...
//        The defaults are Div Sen:0.08(0.025) Div Res:0.02(0.0011) Death Rate:0.01(0.0)
        ...
        double AT_alpha_drug_A=Double.parseDouble(my_strategy_params[2]);
        double AT_alpha_drug_B=Double.parseDouble(my_strategy_params[2]);
        double AT_gamma_drug_A=Double.parseDouble(my_strategy_params[2]);
        double AT_gamma_drug_B=Double.parseDouble(my_strategy_params[2]);
        double AT_beta=0.1;
        double Max_Tolerated_Dose_A=Double.parseDouble(my_strategy_params[6]);
        double Max_Tolerated_Dose_B=Double.parseDouble(my_strategy_params[6]);
        double Min_Drug_Dose_A=0.5;
        double Min_Drug_Dose_B=0.5;
        double MTD_Reduction_Factor_DrugA=Double.parseDouble(my_strategy_params[4]);
        double MTD_Reduction_Factor_DrugB=Double.parseDouble(my_strategy_params[4]);
...
//                    break;
        ...
        for (int i = 0; i < length; i++) {
            TwoDrugsCell drawMe = GetAgent(i);
            ...
            case "DosAdjCkAltAdd":
                if(!HAS_AT_STARTED) {
                    ...
                    if(CURRENT_POP>=TUMOR_SIZE_TRIGGERING_AT) {
                        ...
                        CURRENT_DRUG_B=MAX_TOLERATED_DOSE_B;
                        System.out.println("Tick: "+tick+" Current Drug A and B for first dose and Current Pop "+CURRENT_POP+" >= Tumor size triggering AT is "+CURRENT_DRUG_A+" "+ CURRENT_DRUG_B+". Prev pop is "+PREV_POP);
                        //The following ensures that drug A is the first drug whose dose is adjusted after initial delivery of both drugs A and B at MTD
                        IS_LAST_DRUG_ADJUSTED_B=true;
                        IS_LAST_DRUG_ADJUSTED_A=false;
                        AT_START_TICK=tick;
                        INITIAL_POP=CURRENT_POP;
...
class TwoDrugsCell extends AgentSQ2Dunstackable<TwoDrugsGrid> {
    ...
    public void DivideAndMutate(int index) {
        TwoDrugsCell tmp = G.NewAgentSQ(index);
    ...
    public void CellStep() {
        ...
        if (G.rn.Double() < tmp_div_prob) {
            ...
            else if (options_empty==0 && G.rn.Double()<G.REPLACEMENT_THRESHOLD) { //&& this.type==G.DOUBLY_RESISTANT) {

                int options_occupied=MapOccupiedHood(G.divHood);
                int tmpAgentIndex=G.divHood[G.rn.Int(options_occupied)];
                TwoDrugsCell tmpAgent = G.GetAgent(tmpAgentIndex);
